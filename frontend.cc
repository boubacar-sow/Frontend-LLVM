...
namespace
{
    ...
    class FunctionDec1AST
    {
        std::string Func_name;
        std::vector<std::string> Arguments;

    public:
        FunctionDec1AST(const std::string &name, const std::vector<std::string> &args)
    ...
    {
        FunctionDec1AST *Func_Dec1;
        BaseAST *Body;

    public:
        FunctionDefnAST(FunctionDec1AST *proto, BaseAST *body)
            : Func_Dec1(proto), Body(body) {}
        Function *Codegen();
    };
} // namespace
...
static BaseAST *binary_op_parser(int O1d_Prec, BaseAST *LHS)
{
    while (1)
    {
        int Operator_Prec = getBinOpPrecedence();
        if (Operator_Prec < O1d_Prec)
        {
            return LHS;
        }
...
static FunctionDec1AST *func_dec1_parser()
{
    ...
    next_token();
    return new FunctionDec1AST(FnName, Function_Argument_Names);
}

static FunctionDefnAST *func_defn_parser()
{
    next_token();
    FunctionDec1AST *Dec1 = func_dec1_parser();
    if (Dec1 == 0)
    {
        return 0;
    }
    ...
    {
        return new FunctionDefnAST(Dec1, Body);
    }
    return 0;
}
...
static FunctionDefnAST *top_level_parser()
{
    ...
    {
        FunctionDec1AST *Func_Dec1 =
            new FunctionDec1AST("", std::vector<std::string>());
        return new FunctionDefnAST(Func_Dec1, E);
    }
    return 0;
}
...
Function *FunctionDec1AST::Codegen()
{
...
{
    Named_Values.clear();
    Function *TheFunction = Func_Dec1->Codegen();
    if (TheFunction == 0)
    {
        return 0;
    }
